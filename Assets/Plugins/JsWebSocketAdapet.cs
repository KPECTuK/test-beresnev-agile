...
namespace Nakama
{
	...
	public class UnityWebGLSocketBridge : MonoBehaviour
	{
		...
		public int CreateSocket(string address,
			Action socketOpenHandle,
			Action<int, string> socketCloseHandle,
			Action<string> socketErrorHandle,
			Action<string> socketMessageHandle)
		{
